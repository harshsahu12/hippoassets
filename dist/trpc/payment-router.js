...
exports.paymentRouter = (0, trpc_1.router)({
    createSession: trpc_1.privateProcedure
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var user, productIds, payload, products, filteredProduct, order, line_items, stripeSession, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        filteredProduct = products.filter(function (prod) { return Boolean(prod.priceId); });
                    ...
                    case 3:
                        ...
                        line_items.push({
                            price: "price_1OKfx7SHfcjyNzCl6DwtqApv",
                            quantity: 1,
                            adjustable_quantity: {
                                enabled: false,
                            },
